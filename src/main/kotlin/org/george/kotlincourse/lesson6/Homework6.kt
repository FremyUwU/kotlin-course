package org.george.kotlincourse.lesson6
...
// и возвращает доступные для него категории фильмов: "детские", "подростковые", "18+".
    fun main () {
        println(Season(3))
        println(dogToHumanYears(2.5))
        println(chooseTransport(4.7))
        println(bonusCount(743.00))
    ...
    fun bonusCount(purchaseAmount: Double): Int {
    ...
    fun recommendLook(temperature: Double) : String {
        return when {
            ...
            temperature > -30 && temperature < 0 -> "Куртка и шапка"
            temperature <= 15 && temperature < 35 -> "Ветровка"
